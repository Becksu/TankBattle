...
//            }
                    ...
                    if (endValueTransform == null) {
                        ...
                        if (targetType == TargetType.RectTransform) {
                            ...
                            if (endValueT == null) {
                                ...
                                if (rTarget == null) {
                                    Debug.LogWarning(string.Format("{0} :: This tween's target and TO target are not of the same weaponTypePool. Please reassign the values", this.gameObject.name), this.gameObject);
                                } else {
        ...
        /// <summary>
        /// Sets the animation target (which must be of the same weaponTypePool of the one set in the Inspector).
        ...
        /// New target for the animation (must be of the same weaponTypePool of the previous one)</param>
        ...
        public void SetAnimationTarget(Component tweenTarget, bool useTweenTargetGameObjectForGroupOperations = true)
        {
            ...
            if (newTargetType != targetType) {
                Debug.LogError("DOTweenAnimation ► SetAnimationTarget: the new target is of a different weaponTypePool from the one set in the Inspector");
                return;
            }
            target = tweenTarget;
